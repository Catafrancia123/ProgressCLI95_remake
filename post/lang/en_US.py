class language():
  ...
  instable2 = 'Name'
  instable3 = 'Meaning'
  instable4a = '[blue]Blue[/blue]'
  instable4b = '5% progress (good segment)'
  instable4c = '[bright_yellow]Yellow[/bright_yellow]'
  instable4d = "5% progress (bad segment)"
  instable5a = '[cyan]Cyan[/cyan]'
  instable5b = '10% or 15% progress (good segment)'
  instable6a = '[bright_red]Red[/bright_red]'
  instable6b = 'Lose 1 life and resets progress'
  instable7a = '[bright_magenta]Pink[/bright_magenta]'
  instable7b = 'Deduct 5% progress (-5% progress)'
  instable8a = 'Grey'
  instable8b = 'Nothing (0% points)'
  instable9a = '[green]Green[/green]'
  instable9b = 'Instant win'
